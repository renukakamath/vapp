...
public class Viewnotes extends AppCompatActivity implements JsonResponse, AdapterView.OnItemClickListener {
    ListView l1;
    SharedPreferences sh;
    String[] note,details,value;
public static String deta;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String q = "/Viewnotes?log_id=" +sh.getString("log_id", "")+"&sid="+Viewsubject.sid;
        q = q.replace(" ", "%20");
        JR.execute(q);
    }
